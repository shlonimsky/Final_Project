    ...
    return (!helper ? <CircularProgress /> :
        ...
        <Box m={2} sx={{ minHeight: "70vh" }}>
            ...
            <Box sx={{
                ...
                <Box m={2} className="flex_column" sx={{
                    width: { xs: "100%", md: "60%", lg: "60%" },
                    marginLeft: { xs: "0", md: "3rem" }
                }}
                >
                    <Box sx={{ marginBottom: "15%" }} m={1}>
                    ...
                    <Divider />
                    <Box sx={{ marginBottom: 5 }} m={1}>
                        <Typography variant='h5'>Reviews</Typography>
                        {!reviews || reviews.length === 0 ? <Typography variant='subtitle1'>{helper.first_name} doesn't have any reviews yet</Typography>
                            : reviews.map(review =>
